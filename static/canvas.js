...
var Particle = function () {
  ...
  _createClass(Particle, [{
    ...
    value: function update(dt) {
      ...
      if (this.r < 0.1 || this.life === 0 || this.x + this.r < 0 || this.x - this.r > this.universe.width || this.y + this.r < 0 || this.y - this.r > this.universe.height) {
    ...
    value: function render(ctx) {
      ...
      var spread = 1.5;
      var gradient = ctx.createRadialGradient(this.x, this.y, this.r, this.x, this.y, this.r * spread);
...
var Crown = function () {
  ...
  _createClass(Crown, [{
    ...
    key: 'render',
    value: function render(ctx) {
      var gradient = ctx.createRadialGradient(this.x, this.y, this.r * 0.9, this.x, this.y, this.r);
...
var Explosion = function () {
  function Explosion(world, x, y) {
    ...
    var particles = getRandomInt(25, 50); // 10, 30 amount of particles
...
var ConfettiWorld = function () {
  ...
  _createClass(ConfettiWorld, [{
    ...
    value: function init() {
      ...
      SPA.addEventListener('touchstart', () => {
